...
// problem generator
#define PROBLEM_GENERATOR "two_gaussian_mix"
...
#define COMPILED_WITH_OPTIONS " -I/usr/local/opt/hdf5/include -O3 -std=c++11  -L/usr/local/opt/hdf5/lib  -lhdf5" // NOLINT
...
#define NRAD 14  // Radiation variables for history output
